...
public class MetadataDetails extends APIDetails {
    ...
    public MetadataDetails(String publicUrlPath) {
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_DOCUMENT_MEDIUM,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + FONDS_STATUS,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_FONDS_STATUS,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + DOCUMENT_STATUS,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + DOCUMENT_TYPE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_DOCUMENT_STATUS,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + REGISTRY_ENTRY_STATUS,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_REGISTRY_ENTRY_STATUS,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + PRECEDENCE_STATUS,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_PRECEDENCE_STATUS,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + CORRESPONDENCE_PART_TYPE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_CORRESPONDENCE_PART_TYPE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + SIGN_OFF_METHOD,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_SIGN_OFF_METHOD,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + ELECTRONIC_SIGNATURE_SECURITY_LEVEL,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_ELECTRONIC_SIGNATURE_SECURITY_LEVEL,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + ELECTRONIC_SIGNATURE_VERIFIED,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_ELECTRONIC_SIGNATURE_VERIFIED,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + FORMAT,
                REL_METADATA_FORMAT,
                true
        ));
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_FORMAT,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + FLOW_STATUS,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_FLOW_STATUS,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + REGISTRY_ENTRY_TYPE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_REGISTRY_ENTRY_TYPE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + PART_ROLE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_PART_ROLE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + CLASSIFICATION_TYPE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_CLASSIFICATION_TYPE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + FILE_TYPE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_FILE_TYPE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + VARIANT_FORMAT,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_VARIANT_FORMAT,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + COMMENT_TYPE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_COMMENT_TYPE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + CASE_STATUS,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_CASE_STATUS,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + COUNTRY,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_COUNTRY,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + POST_CODE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_POST_CODE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + SCREENING_METADATA,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_SCREENING_METADATA,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + SCREENING_DOCUMENT,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_SCREENING_DOCUMENT,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + CLASSIFIED_CODE,
        ...
        aPIDetails.add(new APIDetail(
                publicUrlPath + HREF_BASE_METADATA + NEW_CLASSIFIED_CODE,
