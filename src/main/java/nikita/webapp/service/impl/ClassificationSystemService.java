...
public class ClassificationSystemService
    ...
    public ClassHateoas createClassAssociatedWithClassificationSystem(
        ...
        return classService.save(klass, outgoingAddress);
    }
    ...
    public ClassHateoas generateDefaultClass(
        ...
        defaultClass.setTitle("Default Class object generated by nikita " +
                "that can be associated with a ClassificationSystem with " +
                "systemID " + classificationSystemSystemId);
        ClassHateoas classHateoas = new
                ClassHateoas(defaultClass);
        classHateoasHandler.addLinksOnNew(classHateoas, new Authorisation(), outgoingAddress);
        return classHateoas;
    }
    ...
    public ClassificationSystemHateoas findAllClassificationSystem(String outgoingAddress) {
        ClassificationSystemHateoas classificationSystemHateoas = new
