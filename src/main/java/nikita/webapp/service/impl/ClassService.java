...
public class ClassService
     ...
     */
    @Override
    public ClassHateoas save(Class klass, String outgoingAddress) {
    ...
    public ClassHateoas createClassAssociatedWithClass(
            String parentClassSystemId, Class klass, String outgoingAddress) {
        klass.setReferenceParentClass(getClassOrThrow(parentClassSystemId));
        return save(klass, outgoingAddress);
    }
    ...
    public FileHateoas createFileAssociatedWithClass(
        ...
        return fileService.save(file, outgoingAddress);
    }
    ...
    public CaseFileHateoas createCaseFileAssociatedWithClass(
        ...
        return caseFileService.saveHateoas(caseFile, outgoingAddress);
    }
    ...
    public ClassHateoas generateDefaultSubClass(
            @NotNull String classSystemId, String outgoingAddress) {
    ...
    public RecordHateoas createRecordAssociatedWithClass(
        ...
        return recordService.save(record, outgoingAddress);
    }
    ...
    public ClassHateoas findAll(@NotNull String ownedBy, String outgoingAddress) {
        ClassHateoas classHateoas = new
                ClassHateoas((List<INikitaEntity>)
                (List) classRepository.findByOwnedBy(ownedBy));
        classHateoasHandler.addLinks(classHateoas, new Authorisation(), outgoingAddress);
        return classHateoas;
    }
     ...
     */
    @Override
    public ClassHateoas findAllChildren(@NotNull String classSystemId, String outgoingAddress) {
        ClassHateoas classHateoas = new
                ClassHateoas((List<INikitaEntity>)
    ...
    public ClassHateoas handleUpdate(
            ...
            @NotNull Class incomingClass, String outgoingAddress) {
