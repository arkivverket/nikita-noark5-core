...
public class ClassHateoasHandler extends HateoasHandler implements IClassHateoasHandler {
    ...
    public void addEntityLinks(INikitaEntity entity, IHateoasNoarkObject hateoasNoarkObject, String outgoingAddress) {
        ...
        addParentClass(entity, hateoasNoarkObject, outgoingAddress);
        addSubClass(entity, hateoasNoarkObject, outgoingAddress);
    ...
    @Override
    public void addParentClass(INikitaEntity entity, IHateoasNoarkObject hateoasNoarkObject, String outgoingAddress) {
        hateoasNoarkObject.addLink(entity, new Link(outgoingAddress + HATEOAS_API_PATH + SLASH +
                NOARK_FONDS_STRUCTURE_PATH + SLASH + CLASS + SLASH + entity.getSystemId() + SLASH + PARENT_CLASS +
                SLASH, REL_FONDS_STRUCTURE_CLASS, false));
    }
    ...
    @Override
    public void addSubClass(INikitaEntity entity, IHateoasNoarkObject hateoasNoarkObject, String outgoingAddress) {
        hateoasNoarkObject.addLink(entity, new Link(outgoingAddress + HATEOAS_API_PATH + SLASH +
