...
public class FondsCreatorHateoasController extends NoarkController {
    ...
    public ResponseEntity<FondsCreatorHateoas> createFondsCreator(
        ...
        fondsCreatorHateoasHandler.addLinks(fondsCreatorHateoas, new Authorisation(), getAddress(request));
    ...
    public ResponseEntity<FondsCreatorHateoas> getFondsCreatorTemplate(
        ...
        fondsHateoasHandler.addLinksOnNew(fondsCreatorHateoas, new Authorisation(), getAddress(request));
        return ResponseEntity.status(HttpStatus.OK)
                .allow(CommonUtils.WebUtils.getMethodsForRequestOrThrow(request.getServletPath()))
                .body(fondsCreatorHateoas);
    }
