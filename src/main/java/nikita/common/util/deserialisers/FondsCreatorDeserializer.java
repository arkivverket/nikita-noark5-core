...
public class FondsCreatorDeserializer
        extends JsonDeserializer<FondsCreator> {
    ...
    @Override
    public FondsCreator deserialize(JsonParser jsonParser,
        ...
        deserialiseSystemIdEntity(fondsCreator, objectNode, errors);
        deserialiseFondsCreator(fondsCreator, objectNode, errors);
        ...
        if (objectNode.size() != 0) {
            errors.append(String.format(MALFORMED_PAYLOAD,
                    FONDS_CREATOR, checkNodeObjectEmpty(objectNode)));
        }
